...
const categories = [
  {title: "Women's Wear",count: "3268 Items",image: assetUrl("assets/b-1.png"),background: "from-[#d3ecf1] via-[#d3ecf1] to-[#d3ecf1]",contentClass: "max-w-none",imageWrapClass: "w-[62%]",imageClass: "scale-[2.025] object-bottom",imageAlignClass: "items-end",useImageAsBackground: true,},
