...
const GuestProfileState = () => {
  return (
    <section className="site-container py-16 sm:py-20">
      <div className="mx-auto max-w-[820px] overflow-hidden rounded-[10px] border border-[#ece6db] bg-white shadow-[0_24px_60px_rgba(17,17,17,0.08)]">
        <div className="bg-[radial-gradient(circle_at_top_left,#fff5e9_0%,#ffffff_45%,#fffaf5_100%)] px-8 py-12 text-center sm:px-12 sm:py-14">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link to={ROUTES.AUTH.LOGIN} className="rounded-full bg-black px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#111111]">
              Sign In
            </Link>
            <Link to={ROUTES.AUTH.SIGNUP} className="rounded-full border border-[#d9d9d9] px-6 py-3 text-sm font-semibold text-[#111111] transition hover:border-black">
              Create Account
            </Link>
          </div>
        </div>
