      ...
      <div className="border-b border-[#e6ebf1] bg-white px-4 py-4 sm:px-5 sm:py-5 lg:px-7 lg:py-6">
        <div className="flex flex-wrap items-start justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {isRefreshing ? (
              <span className="rounded-full border border-[#dfe4ec] bg-white px-3 py-1.5 text-xs font-medium text-[#4b5563] sm:px-4 sm:py-2 sm:text-sm">Refreshing...</span>
            ) : null}
        ...
        <div className="grid gap-4 p-4 sm:p-5 lg:grid-cols-[minmax(0,280px)_minmax(0,1fr)] lg:p-6 xl:grid-cols-[minmax(0,300px)_minmax(0,1fr)] xl:p-8">
          ...
          <div className="grid gap-4">
            <div className="rounded-[12px] border border-[#e5e9f0] bg-white p-4 sm:rounded-[14px] sm:p-5">
              ...
              <p className="mt-1 text-sm text-[#5b6472]">Core profile information used for orders and account communication.</p>
            ...
            <div className="rounded-[12px] border border-[#e5e9f0] bg-white p-4 sm:rounded-[14px] sm:p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                <div className="rounded-[12px] border border-[#e8edf4] bg-white p-4">
                  <p className="text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-[#8b96a8]"> Verification</p>
                  <p className={`mt-2 inline-flex items-center gap-2 text-sm font-semibold ${   profile?.isEmailVerified ? "text-[#0f9d58]" : "text-[#c77800]" }`}><CheckCircleFilled />{profile?.isEmailVerified ? "Email verified successfully" : "Complete email verification"}
                  </p>
                </div>

                <div className="rounded-[12px] border border-[#e8edf4] bg-white p-4">
                  <p className="text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-[#8b96a8]"> Profile Completeness</p>
                  <p className="mt-2 text-sm font-semibold text-[#111827]">{profileCompleteness}% profile completed</p>
