...
const Profile = ({ section = "info" }: ProfileProps) => {
  ...
  const sections = {
    ...
    "change-password": (<ProfilePlaceholderSection eyebrow="Change Password" title="Change Password" description="Update your account password securely from this section." emptyMessage="Change password form will appear here."/>),
  ...
  return (
    <section className="min-h-screen w-full bg-[radial-gradient(circle_at_top,#fff6ea_0%,#faf8f5_32%,#f7f3ed_100%)]">
      <div className="grid min-h-screen w-full lg:grid-cols-[320px_minmax(0,1fr)]">
        <ProfileSidebar />
        <div className="grid content-start gap-4 p-3 sm:gap-6 sm:p-6 lg:p-8">
