      ...
      <section className="mt-12 py-10 sm:mt-14 sm:py-16">
        <div className="site-container">
          ...
          <div className="mt-10 text-center">
            <Link to={ROUTES.PRODUCTS} className="inline-flex w-full items-center justify-center gap-2 border border-black px-7 py-3 text-sm font-medium text-black transition-colors duration-200 hover:bg-black hover:text-white sm:w-auto">
